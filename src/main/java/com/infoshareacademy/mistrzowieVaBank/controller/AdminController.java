...
import com.infoshareacademy.mistrzowieVaBank.dto.OrderInfo;
...
import com.infoshareacademy.mistrzowieVaBank.validator.ProductFormValidator;
...
public class AdminController {
   ...
   public String product(Model model, @RequestParam(value = "id", defaultValue = "") Long id) {
      ...
      if (id != null) {
         ...
         if (wine != null) {
            wineForm = new WineForm(wine);
         }
      }
      if (wineForm == null) {
         wineForm = new WineForm();
         wineForm.setNewProduct(true);
      }
